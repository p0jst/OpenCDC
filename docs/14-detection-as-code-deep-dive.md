...
5. Scope the matrix before scoring: filter ATT&CK to your threat profile's techniques, per doc 15 §5, and your platforms. "37% of all of ATT&CK" is meaningless; "level ≥2 on 80% of the techniques our top three threat actors use" is a management-grade statement.
