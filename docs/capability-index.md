...
| **GV-3** | Policy framework | [GOVERN](govern.md) | E |
| **GV-4** | Roles & accountability | [GOVERN](govern.md) | E |
| **GV-5** | Budget & resourcing governance | [GOVERN](govern.md) | S |
| **GV-6** | Supply chain risk governance | [GOVERN](govern.md) | S |
| **GV-7** | Oversight & reporting | [GOVERN](govern.md) | E |
| **ID-1** | Asset inventory | [IDENTIFY](identify.md) | E |
| **ID-2** | Data classification | [IDENTIFY](identify.md) | S |
| **ID-3** | Crown-jewel analysis | [IDENTIFY](identify.md) | E |
| **ID-4** | Vulnerability identification | [IDENTIFY](identify.md) | E |
| **ID-5** | Threat landscape & intelligence | [IDENTIFY](identify.md) | S |
| **ID-6** | Risk assessment | [IDENTIFY](identify.md) | S |
| **ID-7** | Improvement identification | [IDENTIFY](identify.md) | S |
| **PR-1** | Identity & access management | [PROTECT](protect.md) | E |
| **PR-2** | Awareness & training | [PROTECT](protect.md) | E |
| **PR-3** | Data security | [PROTECT](protect.md) | S |
| **PR-4** | Platform hardening & secure configuration | [PROTECT](protect.md) | S |
| **PR-5** | Vulnerability remediation & patching | [PROTECT](protect.md) | E |
| **PR-6** | Network security & segmentation | [PROTECT](protect.md) | S |
| **PR-7** | Resilient technology infrastructure | [PROTECT](protect.md) | E |
| **PR-8** | Secure development & change | [PROTECT](protect.md) | A |
| **PR-9** | Email & web protections | [PROTECT](protect.md) | E |
| **DE-1** | Log collection & management | [DETECT](detect.md) | E |
| **DE-2** | Detection engineering | [DETECT](detect.md) | S |
| **DE-3** | Alert triage & analysis | [DETECT](detect.md) | E |
| **DE-4** | Coverage assessment | [DETECT](detect.md) | S |
| **DE-5** | Threat hunting | [DETECT](detect.md) | A |
| **DE-6** | Detection validation | [DETECT](detect.md) | A |
| **DE-7** | Anomaly & integrity monitoring | [DETECT](detect.md) | S |
| **RS-1** | Incident response plan | [RESPOND](respond.md) | E |
| **RS-2** | Playbooks | [RESPOND](respond.md) | E |
| **RS-3** | Incident analysis & forensics | [RESPOND](respond.md) | S |
| **RS-4** | Containment & eradication | [RESPOND](respond.md) | S |
| **RS-5** | Incident reporting & communication | [RESPOND](respond.md) | E |
| **RS-6** | Crisis management interface | [RESPOND](respond.md) | A |
| **RS-7** | Exercises | [RESPOND](respond.md) | S |
| **RC-1** | Recovery planning | [RECOVER](recover.md) | E |
