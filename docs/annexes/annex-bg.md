...
| Field | Value |
|-------|-------|
| Implementing law | Amendment to the Cybersecurity Act (Закон за киберсигурност), State Gazette No. 17 of 13 February 2026, in force same date |
| Competent authority | National Cybersecurity Coordinator / Ministry of e-Government |
| National CSIRT / reporting | CERT Bulgaria at govcert.bg |
| Official starting point | https://www.gov.bg |

## Country notes for your CDC

Bulgaria transposed late, after referral steps by the Commission; implementing acts may still be maturing, so verify the secondary legislation.
...
Tick "Bulgaria" in `tools/regulatory-profile.html` to include this country's references under the `bg-nat` tag.
