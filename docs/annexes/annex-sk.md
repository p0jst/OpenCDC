...
| Field | Value |
|-------|-------|
| Implementing law | Act No. 366/2024 amending Act No. 69/2018 on Cybersecurity, effective 1 January 2025 |
...
Registration through the NBÚ single information system (JISKB); Slovak measures decree specifies controls.
...
Tick "Slovakia" in `tools/regulatory-profile.html` to include this country's references under the `sk-nat` tag.
