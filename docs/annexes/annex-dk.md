...
| **Lov om styrket beredskab i energisektoren** | Energy sector. Combines the cyber side of NIS2 and the physical side of CER into one regime, with requirements beyond the EU minimum such as 24/7 monitoring of critical installations, network segmentation and rules on the location of operations centres | 7 March 2025 | `dk-energi` |
