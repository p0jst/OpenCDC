...
| ID-5 | Threat landscape & intelligence | A documented threat profile: which actors, sectors and MITRE ATT&CK techniques are relevant to *your* organisation. Consume national CSIRT and ENISA advisories. A-tier deep dive on building a full CTI capability: [Deep dive: CTI capability](15-cti-deep-dive.md). |
