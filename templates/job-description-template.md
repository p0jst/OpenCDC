...
## Mission
> Adapt the ECSF profile mission to your scope. For an Incident Responder, for example: monitors the organisation's cybersecurity state, analyses and mitigates the impact of incidents, identifies root causes, and restores systems per the Incident Response Plan.
...
**Must have:** [4–6 ECSF key skills, competence-based, not tool brands]
**Nice to have:** [2–4, incl. platform-specific]
...
---
*Template from the Open CDC Framework, licensed CC BY 4.0. Built on the ENISA European Cybersecurity Skills Framework (ECSF). © ENISA, referenced with attribution.*
