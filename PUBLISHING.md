...
## Cutting a release
1. Update the version in four places: the README badge, the ROADMAP heading, the citation line in `docs/19-references.md`, and the CHANGELOG heading, where you close `Unreleased` and date it.
