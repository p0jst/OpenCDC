...
In Denmark, energy-sector entities also fall under *Lov om styrket beredskab i energisektoren*, which goes beyond the EU baseline on 24/7 monitoring, segmentation and where operations centres may be located; see the [Danish annex](docs/annexes/annex-dk.md). The OT/ICS extension profile is on the [roadmap](ROADMAP.md).
